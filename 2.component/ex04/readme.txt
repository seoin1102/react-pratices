...
01. 기본 개념
    1) state
        ...
        - *************"상태가 변경되면 컴포넌트의 반응형(Reactive) 렌더링의 트리거가 되고 컴포넌트와 자식 컴포넌트 다시 렌더링된다."
...
03. 상태 컴포넌트 vs 순수(Pure, Dumb) 컴포넌트  
    1. 상태 컴포넌트 
        ...
        - 보통 상태 컴포넌트는 순수 컴포넌트를 하나 이상 래핑할 수 잇다.
    2. 순수 컴포넌트
    ...
    *3. 애플리케이션의 컴포넌트들은 상태 컴포넌트와 순수 컴포넌트로 분리하여 개발하는 것이 좋다.    
    4. 어떤 컴포넌트가 상태 컴포넌트인가?
        ...
        - 못찾겠으면, 상태를 관리하는 컴포넌트를 만들고 하위(pure)컴포넌트를 래핑하도록 한다.
    
    예제: emaillist

04. Date Flow(Bottom -> up)
    예제: emaillist    
